...
public static void AddRecord() throws IOException {
	 ...
	 BufferedWriter bw = new BufferedWriter( new FileWriter("D:\\hello\\records.txt",true) );
	 Scanner strInput = new Scanner(System.in);
...
public static void ViewAllRecord() throws IOException {
	 BufferedReader br = new BufferedReader( new FileReader("D:\\hello\\records.txt") );
	...
	public static void DeleteRecordByID() throws IOException {
	 ...
	 File tempDB = new File("D:\\hello\\records_temp.txt");
	 File db = new File("D:\\hello\\records.txt");
